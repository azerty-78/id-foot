    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Vue d&apos;ensemble du système Football ID
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className={`flex items-center justify-between rounded-xl border-l-4 bg-white p-6 shadow-sm ${stat.accent}`}
          >
            <div>
